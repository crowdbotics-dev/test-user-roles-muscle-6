"""
Django settings for test_user_roles_muscle_6 project.
...
ROOT_URLCONF = 'test_user_roles_muscle_6.urls'
...
WSGI_APPLICATION = 'test_user_roles_muscle_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_user_roles_muscle_6 API",
    "DESCRIPTION": "API documentation for test_user_roles_muscle_6 App",
    "VERSION": "v1",
}
